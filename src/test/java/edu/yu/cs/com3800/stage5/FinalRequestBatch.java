...
public class FinalRequestBatch {
    ...
    public static void main(String[] args){
        ...
        if(code == 200){
            System.out.println(response.getBody().split("\n")[0]);
        }
        ...
        TestClient last = new TestClient("localhost", HttpPort, program1);
        Client.Response lastResponse = last.call();
        System.out.println("Request:");
        System.out.println(lastResponse.getSrc());
        System.out.println("Response:");
